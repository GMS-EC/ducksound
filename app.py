...
with app.app_context():
    ...
    try:
        from sqlalchemy import text
        db.session.execute(text('ALTER TABLE canciones ADD COLUMN numero_pista INTEGER'))
        db.session.commit()
        print("Migración completada: Columna 'numero_pista' añadida a la tabla 'canciones'.")
